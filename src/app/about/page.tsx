...
export default function AboutPage() {
  ...
  const { company, visionMission, majorCustomers, stitchingFacility, embroideryDyeingFacility } = profile;
      ...
      <section className="py-20 bg-gray-100">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {majorCustomers.customers.map((customer, index) => (
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="card">
              ...
              <div className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">{stitchingFacility.totalMachines}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Monthly Capacity:</span>
                  <span className="font-semibold">{stitchingFacility.monthlyCapacity}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Production Lines:</span>
                  <span className="font-semibold">{stitchingFacility.productionLines}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Workers:</span>
                  <span className="font-semibold">{stitchingFacility.workers}</span>
                </div>
              </div>
            </div>
            ...
            <div className="card">
              ...
              <div className="space-y-4">
                <div className="flex justify-between">
                  <span className="text-gray-600">Embroidery Machines:</span>
                  <span className="font-semibold">{embroideryDyeingFacility.embroideryMachines}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Dyeing Capacity:</span>
                  <span className="font-semibold">{embroideryDyeingFacility.dyeingCapacity}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Daily Production:</span>
                  <span className="font-semibold">{embroideryDyeingFacility.dailyProduction}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Specialized Workers:</span>
                  <span className="font-semibold">{embroideryDyeingFacility.workers}</span>
                </div>
              </div>
            </div>
          </div>
